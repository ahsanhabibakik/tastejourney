          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-0">
              ...
              <div className="relative lg:col-span-1 group">
                ...
                <div className="absolute top-0 left-0 right-0 bottom-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center space-x-3">
                  <Button
                    size="sm"
                    variant="secondary"
